...
/**
 * Get the status phrase for a given HTTP status code
 */
export function getStatusPhrase(statusCode: number): string {
  return HTTP_STATUS_PHRASES[statusCode] || 'Unknown Status'
}
