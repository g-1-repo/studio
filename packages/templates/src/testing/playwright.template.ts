 ...
 */
export function createBasePlaywrightConfig(options: PlaywrightTemplateConfig = {}): PlaywrightTestConfig {
  return defineConfig({
 ...
 */
export function createMobileTestConfig(options: PlaywrightTemplateConfig = {}): PlaywrightTestConfig {
  return createBasePlaywrightConfig({
    ...options,
    testDir: './e2e/mobile',
    projects: [
 ...
 */
export function createCrossBrowserConfig(options: PlaywrightTemplateConfig = {}): PlaywrightTestConfig {
  return createBasePlaywrightConfig({
    ...options,
    projects: [
      // Desktop browsers
 ...
 */
export function createVisualTestConfig(options: PlaywrightTemplateConfig = {}): PlaywrightTestConfig {
  return createBasePlaywrightConfig({
    ...options,
    testDir: './e2e/visual',
    expect: {
