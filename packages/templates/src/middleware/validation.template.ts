...
export const VALIDATION_MIDDLEWARE = {
   ...
   */
  userRegistration: () => createZodValidation({
    body: z.object({
   ...
   */
  passwordReset: () => createZodValidation({
    body: z.object({
      email: COMMON_SCHEMAS.email
    })
  }),
   ...
   */
  passwordUpdate: () => createZodValidation({
    body: z.object({
   ...
   */
  profileUpdate: () => createZodValidation({
    body: z.object({
   ...
   */
  pagination: () => createZodValidation({
   ...
   */
  jsonContentType: () => createCustomValidation({
